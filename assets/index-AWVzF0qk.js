 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class se{constructor(n){this.apiKey=n}getGenerativeModel(n,t){if(!n.model)throw new h("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new ne(this.apiKey,n,t)}}export{v as BlockReason,z as ChatSession,O as FinishReason,ne as GenerativeModel,se as GoogleGenerativeAI,N as HarmBlockThreshold,I as HarmCategory,y as HarmProbability,w as TaskType};
